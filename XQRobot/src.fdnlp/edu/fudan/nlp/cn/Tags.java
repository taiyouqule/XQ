...
public class Tags {
	...
	//【修改源码】：加protected
	protected static Pattern entitiesPattern  = Pattern.compile("人名|地名|机构名|专有名");
	/**
	...
	//【修改源码】：加protected
	protected static Pattern nounsPattern  = Pattern.compile("名词|人名|地名|机构名|专有名");
	...
	//【修改源码】：加protected
	protected static Pattern stopwordPattern  = Pattern.compile(".*代词|标点|介词|从属连词|语气词|叹词|结构助词|拟声词|方位词");
	/**
	 * 判断词性是否为无意义词。
	 * @param pos 词性
	 * @return true,false
